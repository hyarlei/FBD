...
values ('ana@gmail.com', 'Ana', 'Estudante de Arquitetura', 'F', '2002-04-25', 21);
...
insert into usuario
(email, nome, bio, genero, data_nasc, idade)
values ('lucas@yahoo.com.br', 'Lucas', 'Desenvolvedor Full Stack', 'M', '1995-08-15', 27);

insert into usuario
(email, nome, bio, genero, data_nasc, idade)
values ('juliana@hotmail.com', 'Juliana', 'Publicitária e Fotógrafa', 'F', '1998-11-03', 24);

insert into usuario
(email, nome, bio, genero, data_nasc, idade)
values ('gabriel.silva@gmail.com', 'Gabriel', 'Médico Veterinário', 'M', '1993-06-12', 29);

insert into usuario
(email, nome, bio, genero, data_nasc, idade)
values ('jose.carlos@hotmail.com', 'José Carlos', 'Professor de História', 'M', '1980-01-01', 43);
